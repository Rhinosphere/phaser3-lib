...
var CreatePath = function (scene) {
    let gameObject = new CustomProgress(scene, {
        ...
        update: function () {
            let centerX = this.centerX, centerY = this.centerY, radius = this.radius;
            let lines = this.getShape('pathRef');
            let circle = this.getShape('dot');
