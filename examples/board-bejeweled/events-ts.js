...
class Demo extends Phaser.Scene {
    ...
    create() {
        ...
        let txtScore = this.add.text(650, 30, bejeweled.getData('scores'), { fontSize: '24px', color: '#fff' });
        bejeweled.on('changedata-scores', function (bejeweled, value, previousValue) {
