...
class Card extends Sizer {
    constructor(scene, x, y, data) {
        ...
        var header = new Sizer(scene, {
            ...
            .add(icon, { align: 'center', padding: { right: 10 }, expand: false })
            .add(new Sizer(scene, {
            orientation: 'y'
        })
            .add(nameText, { align: 'left', padding: { bottom: 10 }, expand: false })
            .add(titleText, { align: 'left', expand: false }));
        super(scene, {
            x: x, y: y,
            orientation: 'y',
        ...
        this
            ...
            .add(header, { align: 'left', expand: false })
            .add(attributesChart, { align: 'center', expand: false });
