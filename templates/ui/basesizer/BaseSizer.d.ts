...
declare class BaseSizer extends ContainerLite {
  ...
  isBackground(gameObject: Phaser.GameObjects.GameObject): boolean;

  layout(): this;

  enableLayoutWarn(enable?: boolean): this;

  drawBounds(graphics: Phaser.GameObjects.Graphics, color?: number): this;
  ...
  addChildrenMap(key: string, gameObject: Phaser.GameObjects.GameObject): this;

  addChildrenMap(config: {
  ...
  getTopmostSizer(gameObject?: Phaser.GameObjects.GameObject): BaseSizer | null;
  ...
  getSizerConfig(gameObject?: Phaser.GameObjects.GameObject): {
    [name: string]: any;
  };
  ...
  isInTouching(gameObject?: Phaser.GameObjects.GameObject | string): boolean;

  moveFrom(duration: number, x: number, y: number, ease?: string): this;
  ...
  moveFromDestroy(duration: number, x: number, y: number, ease?: string): this;

  moveFromDestroy(config: {
    x: number;
    y: number;
    speed?: number;
    duration?: number;
  ...
  moveTo(duration: number, x: number, y: number, ease?: string): this;
  ...
  moveToDestroy(duration: number, x: number, y: number, ease?: string): this;

  moveToDestroy(config: {
    x: number;
    y: number;
    speed?: number;
    duration?: number;
  ...
  fadeIn(duration: number, alpha?: number): this;

  fadeInPromise(duration: number, alpha?: number): Promise<any>;

  fadeOutDestroy(duration: number): this;

  fadeOutDestroyPromise(duration: number): Promise<any>;
  ...
  stopEaseData(key: string, toEnd?: boolean): this;

  stopAllEaseData(toEnd?: boolean): this;
  ...
  offClick(callback: Function, scope?: object): this;
  ...
  offClickOutside(callback: Function, scope?: object): this;
  ...
  offTouching(callback: Function, scope?: object): this;
  ...
  offTouchingEnd(callback: Function, scope?: object): this;
  ...
  setChildrenInteractive(config: SetChildrenInteractive.IConfig): this;

  show(gameObject?: Phaser.GameObjects.GameObject): this;

  hide(gameObject?: Phaser.GameObjects.GameObject): this;

  isShow(gameObject: Phaser.GameObjects.GameObject): boolean;
  ...
  modal(onClose?: BaseSizer.OnModalCloseCallbackType): this;

  modalPromise(config?: ModalBehavoir.IConfig): Promise<Object>;

  modalClose(closeEventData?: Object): this;

  broadcastEvent(event: string, ...args: any[]): this;
