...
class DebugDrawPlugin extends Phaser.Plugins.ScenePlugin {
  ...
  showLights: any;
  showRotation: any;
  showInactivePointers: any;
  pointerDownColor: any;
  pointerInactiveColor: any;
  pointerColor: any;
  boot () {
    // @ts-ignore
  ...
  inputDisabledColor(inputDisabledColor: any) {
    throw new Error('Method not implemented.');
  }
  ...
  cameraBoundsColor(cameraBoundsColor: any) {
    throw new Error('Method not implemented.');
  }
  cameraDeadzoneColor(cameraDeadzoneColor: any) {
    throw new Error('Method not implemented.');
  }
  cameraFollowColor(cameraFollowColor: any) {
    throw new Error('Method not implemented.');
  }
  ...
  alpha(color: any, alpha: any) {
    throw new Error('Method not implemented.');
  }
  lineWidth(lineWidth: any, color: any, alpha: any) {
    throw new Error('Method not implemented.');
  }
