...
declare class RoundRectangle extends Phaser.GameObjects.Shape {
  ...
  constructor(scene: Phaser.Scene, config?: RoundRectangle.IConfig);
  ...
  setRadius(value: number | RoundRectangle.IRadiusConfig): this;
  radius: number;

  setRadiusTL(value: number | RoundRectangle.IRadiusConfig): this;
  radiusTL: number;

  setRadiusTR(value: number | RoundRectangle.IRadiusConfig): this;
  radiusTR: number;

  setRadiusBL(value: number | RoundRectangle.IRadiusConfig): this;
  radiusBL: number;

  setRadiusBR(value: number | RoundRectangle.IRadiusConfig): this;
  radiusBR: number;
