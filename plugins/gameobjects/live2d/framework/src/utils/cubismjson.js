...
export class Value {
    ...
    _stringBuffer; // 文字列バッファ
    static s_dummyKeys; // ダミーキー
    static errorValue; // 一時的な返り値として返すエラー。 CubismFramework::Disposeするまではdeleteしない
    static nullValue; // 一時的な返り値として返すNULL。   CubismFramework::Disposeするまではdeleteしない
}
/**
